...
COPY: dict[str, dict[str, str]] = {
    "en": {
        ...
        "operations_notice": "For reliability monitoring, a shortened and sanitized claim excerpt may be sent to our private operations channel.",
        ...
        "examples_title": "Not sure where to start? Try a real claim.",
        "examples_intro": "Choose an example to place it in the investigator. You can review and edit it before anything starts.",
        "example_policy": "Policy",
        "example_energy": "Energy",
        "example_history": "History",
        "example_cash_title": "Is the EU banning cash?",
        "example_cash_claim": "Investigate a widely shared claim about European cash payments.",
        "example_energy_title": "Are renewables now cheaper?",
        "example_energy_claim": "Compare current evidence about energy costs across markets.",
        "example_moon_title": "Were the Moon landings filmed?",
        "example_moon_claim": "Examine a familiar conspiracy claim using traceable sources.",
        "example_try": "Try this claim",
        ...
        "claim_reviewed": "View original and interpreted wording",
        "explore_details": "Explore the evidence",
        "details_hint": "Arguments, source excerpts, scores, and methodology",
    ...
    "hu": {
        ...
        "operations_notice": "A megbízhatóság ellenőrzéséhez az állítás rövidített és személytelenített részlete a privát üzemeltetési csatornánkra kerülhet.",
        ...
        "examples_title": "Nem tudod, mivel kezdd? Próbálj ki egy valódi állítást.",
        "examples_intro": "Válassz egy példát, és betöltjük a vizsgálóba. Indítás előtt átnézheted és módosíthatod.",
        "example_policy": "Közpolitika",
        "example_energy": "Energia",
        "example_history": "Történelem",
        "example_cash_title": "Betiltja az EU a készpénzt?",
        "example_cash_claim": "Vizsgálj meg egy széles körben terjedő állítást az európai készpénzfizetésről.",
        "example_energy_title": "Olcsóbb már a megújuló energia?",
        "example_energy_claim": "Vesd össze az energiaköltségekről szóló friss bizonyítékokat.",
        "example_moon_title": "Stúdióban készült a holdra szállás?",
        "example_moon_claim": "Vizsgálj meg egy ismert összeesküvés-elméletet ellenőrizhető forrásokkal.",
        "example_try": "Állítás kipróbálása",
        ...
        "claim_reviewed": "Eredeti és értelmezett megfogalmazás",
        "explore_details": "Bizonyítékok megnyitása",
        "details_hint": "Érvek, forrásrészletek, pontszámok és módszertan",
